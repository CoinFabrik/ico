...
contract HagglinCrowdsale is Crowdsale {
  ...
  function HagglinCrowdsale(address _teamMultisig, uint _start, uint _end) Crowdsale(_teamMultisig, _start, _end, hubii_minimum_funding) public {
    ...
    // Testing values
    token = new HagglinToken(token_name, token_symbol, token_initial_supply, token_decimals, _teamMultisig);
