...
def config_f():
  ...
  config['endTime'] = int(datetime.now().timestamp()) + 4000 #int(datetime(2018, 7, 14, 10, tzinfo = timezone.utc).timestamp())
  ...
  tranches_start = [int(datetime.now().timestamp()),
                    ...
                    int(datetime.now().timestamp()),
                    int(datetime.now().timestamp())]
  tranches_end = [int(datetime.now().timestamp()) + 2000,
                  int(datetime.now().timestamp()) + 3000,
                  int(datetime.now().timestamp()) + 4000,
                  config['endTime']]
