...
def trans(from_index=0, value=0):
  return {"from": eth.accounts[from_index], "value": value*(10**18), "gas": 4700000, "gasPrice": 2000000000}
...
mw_address = eth.accounts[1]

assert len(mw_address) == 42;
assert mw_address[0:2] == "0x"
