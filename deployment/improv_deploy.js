...
const crowdsale = CS_contract.new(config.milieurs_per_eth, config.MW_address, config.startTime, config.endTime, account, config.tranches, {from: account, data: "0x" + cs_bytecode, gasPrice: 1000000000, gas: 5000000});
