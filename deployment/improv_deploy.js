...
const crowdsale = CS_contract.new(config.MW_address, config.startTime, config.endTime, account, config.tranches, config.milieurs_per_eth, {from: account, data: "0x" + cs_bytecode, gasPrice: 5000000000, gas: 5000000});
